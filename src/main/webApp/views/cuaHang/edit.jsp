...
<body>
<div class="container">
    <sf:form action="${action}" method="post" modelAttribute="ch">
        <div class="mb-3 row">
        ...
        <%--            <div class="col-sm-10">--%>
        <%--                <sf:input path="thanhPho" class="form-control"></sf:input>--%>
        <%--            </div>--%>
        <%--            <div >--%>
        <%--                <small >--%>
        ...
        <%--            <div class="col-sm-10">--%>
        <%--                <sf:input path="quocGia" class="form-control"></sf:input>--%>
        <%--            </div>--%>
        <%--            <div >--%>
        <%--                <small >--%>
