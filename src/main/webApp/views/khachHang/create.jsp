...
<body>
<h1 style="line-height: 100px; text-align: center; color: red">Thêm Khách Hàng</h1>
<div class="col-8 offset-2 mt-3" style="position: relative">
    <sf:form method="POST"
        ...
        <div class="row">
            <div class="col-6">
                <button class="btn btn-primary" style="font-size: 20px;margin-top: 30px; position: absolute; right: 0px;">Thêm</button>
            </div>
            <div class="col-6"></div>
        </div>
    </sf:form>
